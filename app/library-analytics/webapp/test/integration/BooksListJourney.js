...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheBooksList.onTable().iCheckColumns(undefined, {"title":{"header":"Title"},"author/name":{"header":"Author"},"genre":{"header":"Genre"},"price":{"header":"Price"},"stock":{"header":"Stock"},"status":{"header":"Status"}});
